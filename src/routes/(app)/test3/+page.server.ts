...
import { createImage, getEntries, getSubmission, type CurrentImage } from '$lib/components/server/registrationDB';
...
export const load: PageServerLoad = async (event) => {
	...
	return { submission, entries, entryForm, imageUploadForm };
};
